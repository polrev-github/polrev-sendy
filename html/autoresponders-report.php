...
<div class="row-fluid">
    ...
    <div class="span10">
    	...
    	<h3><?php echo get_saved_data('title');?> <a href="<?php echo get_app_info('path');?>/w/<?php echo encrypt_val($id);?>/a" title="<?php echo _('View the web version');?>" class="iframe-preview"><span class="icon-eye-open"></span></a></h3>
